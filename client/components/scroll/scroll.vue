      ...
      <slot
        ...
        <div
          ...
          <div
            ...
            <div
              v-show="!isPullingDown"
              class="c-pulldown-loaded"><span>{{ refreshTxt }}</span></div>
          </div>
        </div>
      </slot>
    </div>
...
<script type="text/ecmascript-6">
  ...
  export default {
    ...
    methods: {
      ...
      scrollTo() {
        this.scroll && Reflect.apply(this.scroll.scrollTo, this.scroll, arguments)
      },
      scrollToElement() {
        this.scroll && Reflect.apply(this.scroll.scrollToElement, this.scroll, arguments)
      },
      clickItem(item) {
