  ...
  <div
    ...
    <div
      ...
      <slot
        ...
        name="message"
      >
        <span class="c-validator-msg-def">{{ dirtyOrValidated ? msg : '' }}</span>
      </slot>
    </div>
  </div>
</template>
...
<script type="text/ecmascript-6">
  ...
  const COMPONENT_NAME = 'c-validator'
  ...
  export default {
    ...
    computed: {
      ...
      containerClass () {
        ...
        return {
          'c-validator_invalid': this.invalid,
          'c-validator_valid': this.valid,
          'c-validator_validating': this.validating
        }
      }
    },
    watch: {
