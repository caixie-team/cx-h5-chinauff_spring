...
export const processFiles = (files, eachProcessFile, eachCb, cb) => {
  const fileItems = []
  ...
  for (let i = 0; i < len; i++) {
    processFile(files[i], i, eachProcessFile, callback)
  }
};

export const processFile = (file, i, eachProcessFile, cb) => {
...
export const newFile = (name = '', size = 0, status = '', progress = 0, file = null) => {
...
export const evalOpts = function (data, ...args) {
